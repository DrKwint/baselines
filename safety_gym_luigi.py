...
reward_shaping = [
    0, -1
]  #, -0.005, -0.01]  #[0, -0.001, -0.0025, -0.005, -0.01, -0.1]
...
def safety_gym_tasks():
    env = ['PointGoal1', 'PointGoal2', 'PointButton1', 'PointButton2']
    constraint = ['simple', 'proximity']
    seed = train_seed
    arg_names = [
        'env_type',
        'env',
...
class TrainTask(luigi.Task):
    ...
    base_path = luigi.Parameter(
        default="/home/equint/GitHub/baselines/safety_gym_tuned/")
    ...
    def get_output_dir(self):
        ...
        return osp.join(
            str(self.base_path).strip("'"), self.get_task_name_str())
    ...
    def run(self):
        ...
        cmd_str += ' --nminibatches 1'
        cmd_str += ' --nsteps 30000'
